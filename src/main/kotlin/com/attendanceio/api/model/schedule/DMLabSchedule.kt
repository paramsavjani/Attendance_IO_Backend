...
/**
 * Represents the default institute-defined weekly lab schedule for each subject.
 * This is used to auto-populate a student's lab timetable when they enroll in subjects.
 */
@Entity
@Table(
    name = "lab_schedule",
